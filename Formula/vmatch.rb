...
class Vmatch < Formula
  ...
  url 'https://api.github.com/repos/anttiharju/vmatch/tarball/build70'
  sha256 'ca7abc7d4aebae716db595edb45e44f0572860abb4540f0dab82433322aabbd0'
  ...
  def install
    ...
    cd bin_path do
      system 'go', 'build', '-ldflags', '-s -w -buildid=brew-build70'
      bin.install 'vmatch'
    end
  end
